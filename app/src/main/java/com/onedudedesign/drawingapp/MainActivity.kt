package com.onedudedesign.drawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestStoragePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(
            ...
            showRationaleDialog(
                "Drawing App", "Drawing App needs to access your " +
                        "External Storage to display a background image of your choice"
            )
        } else {
                ...
                try {
                    ...
                    val f = File(
                        externalCacheDir?.absoluteFile.toString()
                                + File.separator + "DrawingApp_" + System.currentTimeMillis
                            () / 1000 + ".png"
                    )
